...
window.MinaWikiEngine={apiUrl:API_URL,defaultImage:DEFAULT_IMAGE,escapeHTML,normalizeText,safeImage,normalizeSkill,loadSkills,openDetail,openVideo,closeModal,copyText,clearCache(){memoryCache=null;cacheTime=0;}};
})(window,document);
